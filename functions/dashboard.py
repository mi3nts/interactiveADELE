...
if __name__ == "__main__":
    ...
    def interactive_dashboard():
        ...
        app.layout = html.Div(children=[
            ...
            html.Div([  # upper row with brain and hr plot
                ...
                html.Div([
                    ###
                    html.H3(
                        children="Network of High Activity Electrodes (Alpha ~ 8-12 Hz, Beta ~ 12-30 Hz)",
                        style={
                            # 'textAlign': 'center'
                            'margin-left': 100,
                        }
        ...
        def update_alpha_network(value):
            # list of relevant alpha nodes for current epoch
            ...
            stylesheet = [
                ...
                # set the default edges to be low-opacity so that the current-epoch edges will be more prominent
                {'selector': 'edge',
                    'style': {
                        'opacity': 0.2,
                        'width': 1,
            ...
            # make all other nodes low opacity 
            # can this be done in a previous step, in the default stylesheet perhaps?
